...
В `config.h` проверьте, что пины для датчиков указаны правильно. Подключите датчики к ESP32 согласно этим пинам и схеме
устройства, расположенной в `docs/device_schematic.png`.

### 3. Загрузить прошивку

Откройте `plants_monitor/plants_monitor.ino` в Arduino IDE, выбери плату ESP32 и загрузи скетч.
